...
def predict():
    ...
    try:
        ...
        if prediction > 0.7:
            ...
            result = '🟡 INCIERTA PROBABILIDAD DE ANEMIA'
        else:
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port, debug=False)        return False, "La imagen tiene demasiado brillo o reflejo. Evita luz directa muy fuerte."
